...
aws s3 mb s3://hasan-cli-

aws s3 cp in-class.yaml s3://hasan-cli-bucket

aws s3 ls s3://hasan-cli-bucket

aws s3 rm s3://hasan-cli-/in-class.yaml

aws s3 rb s3://hasan-cli-bucket

 aws s3 rb s3://hasan-cli-bucket --force

 aws s3 ls s3://hasan-cli-bucket/ --recursive

 aws s3 rm s3://bucket-name --recursive #bucket files delete
