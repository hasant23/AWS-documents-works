...
# set instance ID
instance_id = "i-09036aff6250d5d5a" # Instance ID, e.g. 'i-0111112233'
# set Hosted Zone ID
zone_id = 'Z04282071TZUSRPMX7N0R' # Hosted Zone ID, e.g. 'ZBDAAABBBCCC'
# domain
domain = 'devopshasan.net' # Domain, e.g. technoff.eu
